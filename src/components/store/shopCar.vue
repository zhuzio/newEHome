    ...
    <div class="wrapper">
      <div class="shop-car-container">
        ...
        <div class="shop-car-list-container">
          <div class="sc-store">
            <p class="sc-store-name">尽然家纺旗舰店<span class="fr">店铺</span></p>
            <div class="sc-goods-container">
              <div class="sc-goods-list">
                ...
                <div class="sc-goods-img"><img src="../../assets/images/2.jpg" alt=""></div>
                <div class="sc-goods-detail">
                  <p class="sc-goods-name">被套单件学生宿舍双人单人150x220x230被罩冬季男女1.5m通用型被罩</p>
                  <div class="sc-goods-type-del">
                    <div class="sc-goods-type">
                      <p><span>颜色：</span>梦幻童话</p>
                      <p><span>尺寸：</span>200x230cm</p>
                    </div>
                 ...
                 <!-- <div class="sc-goods-price sc-goods-integral-and-money">
                  ...
                  <div class="sc-goods-price-total">
                    ...
                    <div class="sc-goods-total">
                      <button>-</button>
                      <input type="text" readonly disabled value="10">
                      <button>+</button>
                    </div>
                  </div>
                </div>
